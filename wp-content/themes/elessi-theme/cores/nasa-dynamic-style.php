...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body #cart-sidebar .widget_shopping_cart_content .btn-mini-cart a.btn-viewcart,
            body #cart-sidebar .widget_shopping_cart_content .btn-mini-cart a.btn-viewcart:hover,
