						...
						<div class="header-main">
							...
							<div class="header-right">
								<div class="header-page-link">
									<?php if( isset($cerio_settings['shipping']) && $cerio_settings['shipping'] ) : ?>
									<div class="phone ship hidden-xs hidden-sm hidden-md ">
										<i class="icon-delivery-truck"></i>
										<div class="content">
											<label class="font-bold"><?php echo esc_html__("FREE SHIPPING  ","cerio") ?></label>
											<span><?php echo esc_html($cerio_settings['shipping']); ?></span>
										</div>
									</div>
									<?php endif; ?>
				...
				<div class="header-bottom">
					<div class="container">
						<div class="content-header-bottom">
							...
							<?php if(( isset($cerio_settings['ship']) && $cerio_settings['ship'] ) || ( isset($cerio_settings['sale']) && $cerio_settings['sale'] )) : ?>
							<div class="list-sale-ship hidden-sm hidden-xs">
								<?php if( isset($cerio_settings['ship']) && $cerio_settings['ship'] ) { ?>
									<div class="ship">
										<?php echo esc_html($cerio_settings['ship']); ?>
									</div>
								<?php } ?>
								<?php if( isset($cerio_settings['sale']) && $cerio_settings['sale'] ) { ?>
									<div class="sale">
										<?php echo esc_html($cerio_settings['sale']); ?>
									</div>
								<?php } ?>
							</div>
							<?php endif ; ?>
