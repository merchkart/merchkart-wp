...
if (!NASA_WISHLIST_ENABLE && NASA_WOO_ACTIVED) :
    ...
    class ELESSI_WOO_WISHLIST {
        ...
        public function btn_wishlist() {
            ...
            <a href="javascript:void(0);" class="btn-wishlist btn-link wishlist-icon tip-top btn-nasa-wishlist" data-prod="<?php echo (int) $productId; ?>" data-prod_type="<?php echo esc_attr($productType); ?>" data-tip="<?php esc_attr_e('Wishlist', 'elessi-theme'); ?>" title="<?php esc_attr_e('Wishlist', 'elessi-theme'); ?>">
