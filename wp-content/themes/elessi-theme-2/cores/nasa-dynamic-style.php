...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body .product-item .product-img-wrap .nasa-product-grid .product-interactions .add-to-cart-btn .add-to-cart-grid:hover .add_to_cart_text
            {
                color: #fff;
            }
            ...
            body .products.list .product-warp-item .group-btn-in-list-wrap .group-btn-in-list .product-interactions .add-to-cart-btn .add-to-cart-grid:hover .add_to_cart_text,
