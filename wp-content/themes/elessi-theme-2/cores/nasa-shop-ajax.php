...
if (!function_exists('elessi_live_search_products')) :
    function elessi_live_search_products() {
        ...
        $the_posts = $search_query->get_posts();
        if ($the_posts) {
            foreach ($the_posts as $the_post) {
                ...
                if (has_post_thumbnail($the_post->ID)) {
                    ...
                    $thumbnail_src = isset($post_thumbnail_src[0]) ? $post_thumbnail_src[0] : false;
                }
                ...
                if ($product = wc_get_product($the_post->ID)) {
                    $results[] = array(
                        ...
                        'image' => '<img src="' . esc_attr($thumbnail_src) . '" class="nasa-item-image-search rtl-right" alt="' . esc_attr($title) . '" height="60" width="60" />',
