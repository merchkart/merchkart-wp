...
<script src="<?php echo ELESSI_THEME_URI; ?>/assets/js/min/jquery.min.js"></script>
</head>
<body>
<?php
...
if (!empty($nasa_opt['coming_soon_img'])) :
    ...
    echo '<img class="img-coming-soon" src="' . ELESSI_THEME_URI . '/assets/images/commingsoon.jpg" />';
endif;
?>
...
<?php
echo shortcode_exists('nasa_follow') ? ('<div class="comingsoon-follow-icons">' . do_shortcode('[nasa_follow]') . '</div>') : '';
?>
