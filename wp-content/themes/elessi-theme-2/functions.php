...
if (!function_exists('elessi_setup')) :
    function elessi_setup() {
        ...
        require_once ELESSI_THEME_PATH . '/cores/nasa-woo-actions.php';
        ...
        require_once ELESSI_THEME_PATH . '/cores/nasa-wishlist.php';
        require_once ELESSI_THEME_PATH . '/cores/nasa-outdate-functions.php';
    }
endif;
