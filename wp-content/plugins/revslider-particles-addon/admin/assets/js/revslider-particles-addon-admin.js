/***************************************************
 * REVOLUTION 6.0.0 PARTICLE EFFECTS ADDON
...
(function($) {
	//'use strict';
		...
		function sanitizePreset(_) {
			...
			if(_.particles_shape_type === undefined) return JSON.parse(_);
			
			var shape = _d(_.particles_shape_type,"circle"),
				size = _d(_.particles_size_value, 6);
			...
			return { 
				...
				enable : true,
				hideOnMobile : _d(_truefalse(_.particles_hide_on_mobile), false),
				particles:{
					shape: shape,
					number:_d(_.particles_number_value,80),
					size: size,
					sizeMin:_d(_.particles_size_min_value,1),
					random:_d(_truefalse(_.particles_size_random), true)				
				},
				styles:{
					border:{
						enable:_d(_truefalse(_.particles_border_enable), false),
						color:_d(_.particles_border_color,'#ffffff'),
						opacity:_d(_.particles_border_opacity,100),
						size:_d(_.particles_border_size,1)
					},
					lines:{
						enable:_d(_truefalse(_.particles_line_enable), false),
						color:_d(_.particles_line_color,'#ffffff'),
						width:_d(_.particles_line_width,1),
						opacity:_d(_.particles_line_opacity,100),
						distance:_d(_.particles_line_distance,150),
					},
					particle:{
						color:_d(_.particles_color_value,'#ffffff'),
						opacity:_d(_.particles_opacity_value,100),
						opacityMin:_d(_.particles_opacity_min_value,10),
						opacityRandom:_d(_truefalse(_.particles_opacity_random), false),
						zIndex:_d(_.particles_zIndex,'default')
					}
				},
				movement:{
					enable:_d(_truefalse(_.particles_move_enable), true),
					randomSpeed:_d(_truefalse(_.particles_move_random), true),					
					speed:_d(_.particles_move_speed,1),
					speedMin:_d(_.particles_move_speed_min,1),
					direction:_d(_.particles_move_direction,"none"),
					straight:_d(_truefalse(_.particles_move_straight), true),
					bounce:_d(_truefalse(_.particles_move_bounce), false)
				},
				interactivity:{					
					hoverMode:_truefalse(_.particles_onhover_enable) ? _d(_.particles_onhover_mode,"repulse") : "none",					
 					clickMode:_truefalse(_.particles_onclick_enable) ? _d(_.particles_onclick_mode,"repulse") : "none"
				},
				bubble:{
					distance:_d(_.particles_modes_bubble_distance,400),
					size:_d(_.particles_modes_bubble_opacity,40),
					opacity:_d(_.particles_modes_bubble_size,40)
				},
				grab:{
					distance:_d(_.particles_modes_grab_distance,400),
					opacity:_d(_.particles_modes_grab_opacity,50)
				},
				repulse:{
					distance:_d(_.particles_modes_repulse_distance,200),
					easing: 100 /* new option */
				},
				pulse:{
					size:{
						enable:_d(_truefalse(_.particles_size_anim_enable), false),
						speed:_d(_.particles_size_anim_speed,40),
						min:_d(_.particles_size_anim_min,1),
						sync:_d(_truefalse(_.particles_size_anim_sync), false)
					},
					opacity:{
						enable:_d(_truefalse(_.particles_opacity_anim_enable), false),
						speed:_d(_.particles_opacity_anim_speed,3),
						min:_d(_.particles_opacity_anim_min,0),
						sync:_d(_truefalse(_.particles_opacity_anim_sync), false)
					}
				}
			};
