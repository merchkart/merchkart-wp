	...
	<div id="<?php echo $widget_id; ?>" class="bwp-countdown <?php echo esc_attr($layout); ?> <?php echo esc_attr($class); ?> <?php if(empty($title1)) echo 'no-title'; ?>">       
		...
		<div class="content-product-list">	
			...
			<?php while($list->have_posts()): $list->the_post();?>
				...
				$product_hot_label = isset($cerio_settings['product-hot-label']) && !empty($cerio_settings['product-hot-label']) ? $cerio_settings['product-hot-label'] : esc_html__('Hot','wpbingo');
				$product_sale_label = cerio_get_product_discount();
				$product_sale = cerio_get_config('product-sale',true);
					...
					<div class="item-product-content products-entry clearfix product-wapper">
						<div class="grid-content">
							...
							<div class="products-content">
								...
								<?php if($show_brands){ cerio_get_brans() ;} ?>
